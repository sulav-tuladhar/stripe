...
export function ProductCard(
    { product, func }: { product: ProductsInterface, func: (data: ProductsInterface) => void }
) {
    return (
        <Card placeholder="" className="w-full max-w-[26rem] shadow-lg" onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
            ...
            <CardFooter className="pt-3" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                <Button size="lg" fullWidth={true} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} onClick={() => func(product)}>
                    {product.price}$ Buy
                </Button>
            </CardFooter>
        </Card>
